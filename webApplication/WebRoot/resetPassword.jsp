...
<html>
  ...
  <script type="text/javascript">
   $(document).ready(function(){
	   ...
	   $(document).InitResetPassword({
		   usernameId:'username',
		   oldPasswordId:'password',
		   newPasswordId_1:'newPassword1',
		   newPasswordId_2:'newPassword2',
           buttonId:'button',
           formId:'login',
           url:'webAuthServlet'
	   });
  ...
  <body>
   ...
   <form id="login" name="login" action="${pageContext.request.contextPath}/servlet/userResetPasswordServlet" method="post">
    <table>
    <tr>       
         <td width="100">  用户名：</td>
